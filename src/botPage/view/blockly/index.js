...
export const load = (blockStr, dropEvent = {}) => {
    ...
    var str = '<field name="SYMBOL_LIST">';
    var field_str = '</field>';
    var start_index = blockStr.search(str);
    var end_index = blockStr.indexOf(field_str, start_index);
    var temp = blockStr.slice(start_index, end_index);
    var symbol = temp.split('>')[1];
    globalObserver.setState({ symbol : symbol }); 
